...
NODE_COLOR2 = 0xffffff00
LINE_COLOR = 0xfffff000
GREEN = 0xFF00FF00
WHITE = 0xFFFFFFFF
BLUE = 0xFF0000FF
...
def connect(screen, obj, pos, npos):
    if id(obj) in drawn:
        pygame.draw.line(screen, LINE_COLOR, pos, drawn[id(obj)], 5)
    else:
...
def draw(obj, screen, x, y):
    ...
    if type(obj) in (StartNode, StopNode):
        ...
        pygame.draw.polygon(screen, NODE_COLOR, rhombus((x,y,NODEW,NODEH)))
...
while True:
    ...
    if event.type == pygame.QUIT:
        pygame.image.save(SCREEN, "xyz3.jpeg")
        break
